    ...
    <div className='bg-amber-50' >
      ...
      <div className='h-screen w-screen overflow-hidden flex flex-col justify-center items-center'>
        ...
        <div className='mt-10 flex flex-col items-center'>
          <button className='w-[350px] text-xl active:bg-gray-600 font-thin text-gray-300 bg-black rounded-lg p-2' onClick={onClickOpenChordMenu} >Chords In <span className='text-white font-bold'>{chordIn}</span> {chordIn == initChordIn ? 'Scale' : 'Natual Major Scale'} <span className='font-bold'>∨</span></button>
          {openChordMenu &&
